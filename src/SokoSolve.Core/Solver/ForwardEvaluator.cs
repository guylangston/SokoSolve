...
namespace SokoSolve.Core.Solver
{
    public interface INodeEvaluator
    {
        ...
        bool Evaluate(SolverCommandResult state, ISolverQueue queue, ISolverNodeLookup pool, ISolverNodeLookup solutionPool, SolverNode node);
    }
    ...
    public class ForwardEvaluator : INodeEvaluator
    {
        ...
        public bool Evaluate(SolverCommandResult state, ISolverQueue queue, ISolverNodeLookup pool, ISolverNodeLookup solutionPool,  SolverNode node)
        {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (newKid.CrateMap.BitwiseAND(state.StaticMaps.GoalMap).Equals(newKid.CrateMap))
                                            {
                                                // Solution
