...
namespace Sokoban.Core.Solver
{
    ...
    public class SingleThreadedForwardReverseSolver : ISolver
    {
        ...
        public virtual string VersionDescription
        {
            get
            {
                return "Single-threaded logic for solving a Reverse and a Forward solver on a SINGLE pool";
            }
        }
        ...
        private bool DequeueAndEval(CommandResult state, SolverData part, ISolverNodeLookup pool, ISolverNodeLookup solution)
        {
