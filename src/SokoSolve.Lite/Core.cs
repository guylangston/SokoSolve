...
namespace SokoSolve.Base
{
    ...
    public enum Cell
    {
        ...
        FloorGoal = Floor + Block.Goal,
        FloorCrate = Floor + Block.Crate,
        FloorPlayer = Floor + Block.Player,

        FloorGoalCrate = Floor + Block.Goal + Block.Crate,
        FloorGoalPlayer = Floor + Block.Goal + Block.Player
    }
