...
public static class TestLibrary
{
    ...
    public static LibraryPuzzle SlimyTown = new LibraryPuzzle(SokobanPuzzle.Builder.FromLines(new[]
    {
        "~##~#####",
        "##.##.O.#",
        "#.##.XO.#",
    ...
    public static LibraryPuzzle GrimTown = new LibraryPuzzle(SokobanPuzzle.Builder.FromLines(new[]
    {
        "~~~~~~~~~~~#####",
        "~~~~~~~~~~##...#",
        "~~~~~~~~~~#....#",
